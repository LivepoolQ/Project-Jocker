...
from .conception import ConceptionLayer, SegmapLayer, FusionLayer

nn = torch.nn

class GrouplusModel(qpid.model.Model):
    """
    """
    def __init__(self, structure=None, *args, **kwargs):
        ...
        self.gplus_args = self.args.register_subargs(GrouplusModelArgs, 'gp_args')
    ...
    def forward(self, inputs, training=None, mask=None, *args, **kwargs):
        ...
        segmap_circle = self.sl.implement(self, inputs)
        f_social = self.fusion(conception_circle, segmap_circle)
        f_social = self.tse(f_social)
...
class GrouplusStructure(qpid.training.Structure):
    MODEL_TYPE = GrouplusModel